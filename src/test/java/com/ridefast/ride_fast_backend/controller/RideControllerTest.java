...
class RideControllerTest {
    ...
    void requestRide_with_user_role_returns_ok() throws Exception {
        ...
        Mockito.when(rideService.requestRide(Mockito.any(RideRequest.class), Mockito.any(MyUser.class)))
                .thenReturn(ride);
        Mockito.when(modelMapper.map(Mockito.eq(ride), Mockito.eq(RideDto.class))).thenReturn(rideDto);
