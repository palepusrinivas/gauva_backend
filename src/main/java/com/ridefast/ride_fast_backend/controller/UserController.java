...
public class UserController {
  ...
  @GetMapping("/{userId}")
  public ResponseEntity<UserResponse> findUserByIdHandler(@PathVariable String userId) throws ResourceNotFoundException {
  ...
  public ResponseEntity<List<RideDto>> getMethodName(@PathVariable String userId) throws ResourceNotFoundException {
  ...
  public ResponseEntity<List<RideDto>> requestRide(@PathVariable String userId) throws ResourceNotFoundException {
